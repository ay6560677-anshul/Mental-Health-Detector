...
def confusion_matrix_figure():
    ...
    The project materials provide overall train/test accuracy but do not
...
with st.sidebar:
    ...
    st.caption("For educational and demonstration purposes. This dashboard is not a medical diagnostic tool.")
...
if section == "🔮 Interactive Predictor":
    ...
    st.warning(
        "Safety note: MindShield is a machine-learning demonstration, not a clinical "
        "assessment system. A predicted category should never be used as a diagnosis, "
        "risk determination, or substitute for professional support."
    )
